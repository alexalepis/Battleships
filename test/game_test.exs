defmodule GameTest do
  ...
  test "play round" do
    ...
    player=Player.place_custom(game.current_player, Enum.at(game.current_player.enemy_fleet.ships, 1), 1, 1, :vertical)
    player=Player.place_custom(player, Enum.at(game.current_player.enemy_fleet.ships, 2), 2, 1, :vertical)
    player=Player.place_custom(player, Enum.at(game.current_player.enemy_fleet.ships, 0), 3, 1, :vertical)
    game=%{game | current_player: player}

    player2=Player.place_custom(game.enemy_player, Enum.at(game.enemy_player.enemy_fleet.ships, 0), 1, 1, :horizontal)
    player2=Player.place_custom(player2, Enum.at(game.enemy_player.enemy_fleet.ships, 1), 1, 2, :horizontal)
    player2=Player.place_custom(player2, Enum.at(game.enemy_player.enemy_fleet.ships, 2), 1, 3, :horizontal)
